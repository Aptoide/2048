...
public class LocalGameStatusRepository {
    ...
    public LocalGameStatusRepository(UserDataStorage userDataStorage, GameFieldConverter gameFieldConverter) {
    ...
    public LocalGameStatus getGameStatus() {
        ...
        Tile[][] field = gameFieldConverter.toField(userDataStorage.getString(GAME_STATUS_PREFIX + FIELD));
        long score = userDataStorage.getLong(GAME_STATUS_PREFIX + SCORE);
        removeLocalGameStatus();
        return new LocalGameStatus(session, field, score);
    }
