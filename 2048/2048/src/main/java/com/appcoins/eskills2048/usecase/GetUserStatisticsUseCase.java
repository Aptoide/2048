...
public class GetUserStatisticsUseCase {
    ...
    public Single<GeneralPlayerStatsResponse> execute(String applicationId, String userWalletAddress,
                                                      String matchEnvironment, StatisticsTimeFrame timeFrame) {
        return statisticsRepository.getUserStatistics(applicationId, userWalletAddress, null, matchEnvironment, timeFrame)
